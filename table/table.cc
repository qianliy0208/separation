...
FILE* Table::l0_read_block_per_time_ = fopen("/home/chen/LV_L0_GET.txt", "w+");
FILE* Table::l1_read_block_per_time_ = fopen("/home/chen/LV_L1_GET.txt", "w+");
FILE* Table::l2_read_block_per_time_ = fopen("/home/chen/LV_L2_GET.txt", "w+");
FILE* Table::l3_read_block_per_time_ = fopen("/home/chen/LV_L3_GET.txt", "w+");
FILE* Table::l4_read_block_per_time_ = fopen("/home/chen/LV_L4_GET.txt", "w+");
FILE* Table::l5_read_block_per_time_ = fopen("/home/chen/LV_L5_GET.txt", "w+");
FILE* Table::l6_read_block_per_time_ = fopen("/home/chen/LV_L6_GET.txt", "w+");
///////////////////////////////////////
...
Iterator* Table::BlockReader(void* arg,
  ...
  std::vector<uint8_t>* fmd_stage = reinterpret_cast<std::vector<uint8_t>*>(arg2);
    ...
    if (block_cache != NULL) {
      ...
      if (cache_handle != NULL) {
        ...
        s = ReadBlock(table->rep_->file, options, handle, &contents, 
                      ...
                      Table::read_block_stats_, arg3, fmd_stage);
        ///////////////////////////////////////
...
Status Table::InternalGet(const ReadOptions& options, 
  ...
  //// <fg_stats_>
  fg_stats_->find_index_key_time += Env::Default()->NowMicros() - itgt_start;
  ...
  if (iiter->Valid()) {
    ...
    if (filter != NULL &&
      ...
      //// <fg_stats_>
      uint64_t igsdb_start = Env::Default()->NowMicros();

      Iterator* block_iter = BlockReader(this, options, iiter->value(), fmd_stage, level);
      block_iter->Seek(k);

      //// <fg_stats_>
      fg_stats_->internal_get_seek_data_block_time += Env::Default()->NowMicros() - igsdb_start;
